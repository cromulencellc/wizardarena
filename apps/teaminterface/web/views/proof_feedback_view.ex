defmodule Teaminterface.ProofFeedbackView do
  use Teaminterface.Web, :view

  import Teaminterface.DashboardView, only: [digest: 1]
  ...
  def filter_explainer(conn, params) do
    ...
    |> Enum.map(fn({name, value}) ->
      ...
      remove_link = link("x",
                         to: proof_feedback_path(conn, :index, remove_params),
                         class: "shape")
